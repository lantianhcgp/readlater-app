            ...
            try {
                ...
                for (tagName in result.tags) {
                    ...
                    if (tag == null) {
                        ...
                        Logger.d("ArticleRepository", "创建新标签: $tagName")
                    }
                    tagDao.insertArticleTag(ArticleTag(articleId = articleId, tagId = tag.id))
                    Logger.d("ArticleRepository", "关联标签: $tagName -> $articleId")
                }
                
                Logger.i("ArticleRepository", "文章处理完成: ${result.title}, 标签数: ${result.tags.size}")
            } catch (e: Exception) {
